...
public class MapCanvasController : MonoBehaviour
{
	...
	void Update () 
    {
        ...
        if (rotateMap)
        {
            ...
            mapRect.rotation = Quaternion.Euler(new Vector3(playerTransform.eulerAngles.x, playerTransform.eulerAngles.y, playerTransform.eulerAngles.y));
            mapArrow.rotate(Quaternion.Euler(new Vector3(playerTransform.eulerAngles.x, playerTransform.eulerAngles.y, 0)));
        }
        else
        {
